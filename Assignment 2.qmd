...
apa.reg.table(H1, filename = "H1 Regression Table 1.docx", table.number = 1)
...
apa.reg.table(H1, filename= "H1 Regression Table 2. docx", table.number = 2, prop.var.conf.level = 0.95)
...
apa.cor.table(H2, table.number = 3, filename = "H2 Correlation Table 3.docx")
...
Control <- lm(NegAff_summed ~ CONS_summed + sex, data = A2)
Predictor <- lm(NegAff_summed ~ CONS_summed + SPP_summed + sex, data = A2)

Table4 <- apa.reg.table(Control, Predictor,
                        table.number = 4,
                        filename="H2 Regression Control and Predictor Table 4.docx")
```
