...
apa.reg.table(H1, filename = "H1 Assignment 2.docx", table.number = 1)
...
apa.reg.table(H1, filename=NA, table.number = 2, prop.var.conf.level = 0.95)

```

Table 2 Analysis : Bivariate correlations between sex, conscientiousness, and SPP. There are notable correlations between nearly every variable pair except for sex and socially prescribed perfectionism; we will therefore require a second analysis to examine the isolated effect of socially prescribed perfectionism (H2)
